...
//   - kFloat32
//   - kFloat64
//   - TODO (planglois): Add support for kSimd128. id:1717 gh:1725
...
class TestEnvironment : public HandleAndZoneScope {
 public:
  ...
  // TODO (all): Test all types of constants (e.g. ExternalReference and id:1507 gh:1516
  // HeapObject).
  ...
  TestEnvironment()
      : blocks_(main_zone()),
        ...
        // TODO (planglois): Support kSimd128. id:1813 gh:1821
    ...
    // TODO (planglois): Support kSimd128 stack slots. id:1531 gh:1539
...
//
// TODO (planglois): We execute moves on stack parameters only which restricts id:1676 gh:1684
...
class CodeGeneratorTester {
 public:
  explicit CodeGeneratorTester(TestEnvironment* environment)
    ...
    // TODO (all): Generate a stack check here so that we fail gracefully if the id:1718 gh:1726
    // frame is too big.
  }
