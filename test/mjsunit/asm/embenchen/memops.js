...
var Runtime = {
    ...
    type.flatIndexes = type.fields.map(function(field) {
      ...
      if (Runtime.isNumberType(field) || Runtime.isPointerType(field)) {
        ...
        if (field[1] === '0') {
          ...
          // and it adds no size
          // XXX this happens in java-nbody for example... assert(index === type.fields.length, 'zero-length in the middle!'); id:2088 gh:2096
          size = 0;
  ...
  UTF8Processor: function () {
    ...
    this.processJSString = function processJSString(string) {
      /* TODO: use TextEncoder when present, id:2122 gh:2130
...
// for 32-bit unsigned values or more than 32 bits. TODO: audit all uses of tempInt id:1869 gh:1877
...
function Pointer_stringify(ptr, /* optional */ length) {
  // TODO: use TextDecoder id:2137 gh:2145
...
function reSign(value, bits, ignore) {
  ...
  if (value >= half && (bits <= 32 || value > half)) { // for huge values, we can hit the precision limit and always get true here. so don't do that
                                                       ...
                                                       // TODO: In i64 mode 1, resign the two parts separately and safely id:1797 gh:1805
...
function copyTempDouble(ptr) {
  ...
  var MEMFS={ops_table:null,CONTENT_OWNING:1,CONTENT_FLEXIBLE:2,CONTENT_FIXED:3,mount:function (mount) {
        ...
        if (node.contentMode !== MEMFS.CONTENT_FLEXIBLE) {
          ...
          // NOTE: In our implementation, st_blocks = Math.ceil(st_size/st_blksize), id:2089 gh:2097
  ...
  var NODEFS={isWindows:false,staticInit:function () {
        ...
        if (flags in NODEFS.flagsToPermissionStringMap) {
          ...
          // FIXME this is terrible. id:2123 gh:2131
          ...
          // FIXME this is terrible. id:1870 gh:1878
  ...
  function _fflush(stream) {
      ...
      // we don't currently perform any user-space buffering of data
        ...
        if (!FS.FSNode) {
          ...
          // NOTE we must use Object.defineProperties instead of individual calls to id:2138 gh:2146
        ...
        // TODO if PROT is PROT_WRITE, make sure we have write access id:1798 gh:1806
        if ((stream.flags & 2097155) === 1) {
        ...
        // TODO deprecate the old functionality of a single id:2090 gh:2098
        ...
        LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
            ...
            var doXHR = (function(from, to) {
              ...
              // TODO: Use mozResponseArrayBuffer, responseStream, etc. if available. id:2124 gh:2132
              var xhr = new XMLHttpRequest();
              xhr.open('GET', url, false);
        ...
        Browser.init();
        // TODO we should allow people to just pass in a complete filename instead id:1871 gh:1879
  ...
  function _mkport() { throw 'TODO' }var SOCKFS={mount:function (mount) {
        ...
        return 'socket[' + (SOCKFS.nextname.current++) + ']';
          ...
          sock.server = new WebSocketServer({
            host: host,
            port: sock.sport
            // TODO support backlog id:1799 gh:1807
          });
          ...
          if (peer) {
            ...
            // TODO saddr and sport will be set for bind()'d UDP sockets, but what id:2091 gh:2099
      ...
      // TODO honor flags id:2125 gh:2133
  ...
  function __reallyNegative(x) {
      ...
      function getNextArg(type) {
        // NOTE: Explicitly ignoring type safety. Otherwise this fails: id:1872 gh:1880
        //       int x = 4; printf("%c\n", (char)x);
        var ret;
        if (type === 'double') {
      ...
      while(1) {
        ...
        if (curr == 37) {
          ...
          textIndex += 2;
          // TODO: Support a/A (hex float) and m (last error) specifiers. id:2149 gh:2157
          // TODO: Support %1${specifier} for arg selection. id:1800 gh:1808
        } else {
          ret.push(curr);
          textIndex += 1;
        }
  ...
  var Browser={mainLoop:{scheduler:null,method:"",shouldPause:false,paused:false,queue:[],pause:function () {
        ...
        audioPlugin['handle'] = function audioPlugin_handle(byteArray, name, onload, onerror) {
          ...
          if (Browser.hasBlobConstructor) {
            ...
            var url = Browser.URLObject.createObjectURL(b); // XXX we never revoke this! id:2092 gh:2100
            var audio = new Audio();
    ...
    // FIXME: ideally this should be clamped against the canvas size and zero id:2126 gh:2134
...
function exit(status) {
  ...
  // TODO We should handle this differently based on environment. id:1873 gh:1881
