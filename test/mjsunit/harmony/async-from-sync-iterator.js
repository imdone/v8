...
(function ExtractedAsyncFromSyncIteratorMethods() {
  // TODO (ishell, caitp): Rewrite the test without using function.caller. id:2038 gh:2046
  ...
  // TODO (caitp): test extracted `throw` method using yield* in async generator. id:2302 gh:2310
