...
RUNTIME_FUNCTION(Runtime_ObjectHasOwnProperty) {
  ...
  if (object->IsJSModuleNamespace()) {
    ...
    // prototypes.
    // TODO (jkummerow): Make JSReceiver::HasOwnProperty fast enough to id:1259 gh:1267
...
// TODO (verwaest): Support the common cases with precached map directly in id:1575 gh:1583
...
RUNTIME_FUNCTION(Runtime_ObjectCreate) {
  ...
  // TODO (bmeurer): Use a dedicated cache for Object.create; think about id:1306 gh:1314
