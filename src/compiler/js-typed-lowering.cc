...
class JSBinopReduction final {
 public:
  ...
  Reduction ChangeToPureOperator(const Operator* op, Type* type = Type::Any()) {
    ...
    // TODO (jarin): Replace the explicit typing hack with a call to some method id:622 gh:623
...
// TODO (turbofan): js-typed-lowering improvements possible id:633 gh:634
...
Reduction JSTypedLowering::ReduceCreateConsString(Node* node) {
  ...
  if (isolate()->IsStringLengthOverflowIntact()) {
    ...
    Node* efalse = effect;
    {
      ...
      // TODO (bmeurer): This should be on the AdvancedReducer somehow. id:664 gh:665
  ...
  // TODO (turbofan): We currently just use the cons_string_map here for id:538 gh:539
...
Reduction JSTypedLowering::ReduceJSToStringInput(Node* input) {
  ...
  // TODO (turbofan): js-typed-lowering of ToString(x:number) id:582 gh:583
  return NoChange();
}
...
Reduction JSTypedLowering::Reduce(Node* node) {
  switch (node->opcode()) {
    ...
    // TODO (mstarzinger): Simplified operations hiding in JS-level reducer not id:623 gh:624
